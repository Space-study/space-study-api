...
export class IssuesService {
  ...
  findByProjectId(projectId: Project['id']): Promise<Issue[]> {
    return this.issueRepository.findByProjectId(projectId);
  }

  updateIssueStatus(id: Issue['id'], status: Issue['status']): Promise<Issue> {
    return this.issueRepository.updateIssueStatus(id, status);
  }
